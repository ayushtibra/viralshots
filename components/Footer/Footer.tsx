  ...
  return (
    ...
    >
      ...
      <div className={`scrollToTop ${showButton ? "block" : "hidden"}`}>
        ...
        >
          <img src="/images/icons/new-up-arrow.png" alt="scrollToTop" />
        </button>
      </div>
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:pt-16 lg:pb-4 lg:px-8">
        <div className="xl:grid xl:grid-cols-4 xl:gap-8">
          <div className="xl:col-span-1 flex flex-col justify-center items-center">
            <Link href="/">
              <a className="logo-footer flex mb-4">
                {" "}
                <Image src="/images/logo/trending.png" width={45} height={45} />
              </a>
            </Link>
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-3">
            <div className="get-in-touch site-foot-nav-left flex justify-center">
              <div
                className="footer-customer-care mt-0"
                style={{ marginTop: "0px" }}
              >
                <Link href="/">
                ...
                <Link href="/">
                  <p>Email: viralshots@gmail.com</p>
                </Link>
              </div>
            </div>
        ...
        <div className="mt-12 border-t border-gray-200 pt-8 flex justify-between">
          <span className="text-base text-gray-400 xl:text-left">
            &copy; 2022 ViralShots, Inc. All rights reserved.
          </span>
          <span className="text-base text-gray-400 xl:text-right">
